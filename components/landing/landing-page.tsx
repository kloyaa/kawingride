...
const featureToneClasses = {
  amber: {
    card: "border-amber-200/60 bg-amber-50/80",
    icon: "bg-amber-500 text-white",
    text: "text-amber-950",
  },
  brand: {
    card: "border-brand-200/60 bg-brand-50/80",
    icon: "bg-brand-700 text-white",
    text: "text-brand-950",
  },
  emerald: {
    card: "border-emerald-200/60 bg-emerald-50/80",
  ...
  violet: {
    card: "border-violet-200/60 bg-violet-50/80",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
          ...
          <div className="section-shell relative">
            <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16">
              <div className="space-y-8">
                <div className="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-white/80 px-3.5 py-1.5 text-xs font-semibold text-brand-800 shadow-sm backdrop-blur">
                ...
                <div className="space-y-5">
                  <h1 className="font-display text-4xl font-extrabold leading-none tracking-tight text-slate-950 sm:text-5xl lg:text-[3.4rem]">
                    Find riders,
                    <br />
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a
                    href="#problem"
                    className="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-white px-5 py-3 text-sm font-semibold text-brand-800 transition hover:bg-brand-50"
                  >
              ...
              <div className="glass-panel rounded-[2rem] p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
                <div className="mb-5 flex items-center gap-2 border-b border-slate-100 pb-4">
                  ...
                  <span className="ml-2 text-xs font-medium text-slate-400">community-ride.app</span>
                </div>
                ...
                <article className="mt-4 rounded-3xl border border-slate-100 bg-white p-5 shadow-sm">
                  ...
                  <div className="grid gap-4 sm:grid-cols-[auto_minmax(0,1fr)_auto] sm:items-start">
                    ...
                    <div className="space-y-3">
                      <div>
                        <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-400">Pickup</p>
                        <p className="text-sm font-semibold text-slate-800">Gaisano Capital Mall</p>
                      </div>
                      <div>
                        <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-400">Drop-off</p>
                        <p className="text-sm font-semibold text-slate-800">SM City Cagayan</p>
                      </div>
                    </div>
                    <div className="text-left sm:text-right">
                      <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-400">Offer</p>
                      <p className="font-display text-2xl font-extrabold text-brand-700">₱120</p>
                      <p className="text-xs text-slate-400">2 bids received</p>
                    </div>
                  </div>
                </article>
              </div>
          ...
          <div className="section-shell">
            ...
            <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {problemCards.map((item, index) => (
                <article
                  key={item.title}
                  className="card-lift rounded-3xl border border-red-100 bg-white p-6 shadow-sm"
                >
                  <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-2xl bg-red-50 font-display text-sm font-bold text-red-600">
          ...
          <div className="section-shell">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {solutionPillars.map((item, index) => (
                <article key={item.title} className="card-lift rounded-3xl border border-slate-100 bg-white p-5 shadow-sm">
                  <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-2xl bg-brand-50 font-display text-sm font-bold text-brand-700">
                    {String(index + 1).padStart(2, "0")}
                  </div>
                  <h3 className="font-display text-base font-bold text-slate-950">{item.title}</h3>
                  <p className="mt-2 text-sm leading-6 text-slate-600">{item.description}</p>
                </article>
              ))}
            </div>
          ...
          <div className="section-shell">
            ...
            <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {howItWorksSteps.map((item, index) => {
                ...
                return (
                  <article key={item.title} className="card-lift rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
            ...
            <div className="mt-12 rounded-[2rem] border border-slate-100 bg-slate-50 p-6 md:p-8">
              <h3 className="font-display text-xl font-extrabold text-slate-950">What users no longer need to say</h3>
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <article className="rounded-3xl border border-red-100 bg-red-50 p-5">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-display text-sm font-bold text-red-900">Old social media flow</h4>
                  </div>
                ...
                <article className="rounded-3xl border border-brand-100 bg-brand-50 p-5">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-display text-sm font-bold text-brand-900">New structured flow</h4>
                  </div>
                  <ul className="mt-4 space-y-2 text-sm leading-6 text-brand-900">
        ...
        <section id="safety" className="bg-slate-50 py-20 md:py-28">
          <div className="section-shell">
            <SectionHeader
              badge="Safety"
              icon="shield"
            ...
            <div className="mt-14 rounded-[2rem] border border-slate-100 bg-white p-6 shadow-sm md:p-10">
              <h3 className="font-display text-lg font-extrabold text-slate-950">Notification timeline</h3>
              <div className="relative mt-6">
                <div className="absolute left-5 top-5 hidden w-px rounded-full bg-gradient-to-b from-brand-300 via-brand-200 to-slate-200 sm:bottom-5 sm:block" />
                <div className="space-y-5">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              ...
              <article className="rounded-3xl border border-brand-100 bg-gradient-to-br from-brand-50 to-emerald-50 p-6">
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-2">
              <article className="rounded-3xl border border-red-100 bg-red-50 p-6">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-display text-base font-bold text-red-900">What social media often gives you</h3>
                </div>
                <ul className="mt-5 space-y-3">
                  {whyLegacyItems.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-sm leading-6 text-red-800">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-red-400" />
                      <span>{item}</span>
                    </li>
                  ))}
              ...
              <article className="rounded-3xl border border-brand-100 bg-brand-50 p-6">
                <div className="flex items-center gap-2">
                  <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-brand-100 text-brand-700">
                    <Icon name="check" className="h-3.5 w-3.5" />
                  </span>
                  <h3 className="font-display text-base font-bold text-brand-900">What this platform gives you</h3>
                </div>
                <ul className="mt-5 space-y-3">
                  {whyPlatformItems.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-sm leading-6 text-brand-900">
                      <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-brand-100 text-brand-700">
                        <Icon name="check-circle" className="h-4 w-4" />
                      </span>
                      <span>{item}</span>
        ...
        <section id="pricing" className="bg-white py-20 md:py-28">
          <div className="section-shell">
                  ...
                  <article
                    ...
                    className={
                      plan.featured
                        ...
                        : "card-lift rounded-[2rem] border border-slate-100 bg-gradient-to-br from-slate-50 to-white p-7 shadow-sm"
                    }
                  >
                    {plan.featured ? (
                    ...
                    <div className="mt-2 flex items-baseline gap-2">
                      <span className={plan.featured ? "font-display text-4xl font-extrabold text-white" : "font-display text-4xl font-extrabold text-slate-950"}>
                        {plan.price}
                      </span>
                      <span className={plan.featured ? "text-sm text-brand-200" : "text-sm text-slate-400"}>/month</span>
                    </div>

                    {plan.description ? (
                      <p className={plan.featured ? "mt-1 text-sm text-brand-200" : "mt-1 text-sm text-slate-500"}>
                        {plan.description}
                      </p>
                    ) : null}

                    <p className={plan.featured ? "mt-4 text-sm leading-6 text-brand-100" : "mt-4 text-sm leading-6 text-slate-600"}>
                      {plan.discount}
                    </p>

                    <div className={plan.featured ? "mt-5 border-t border-white/10 pt-5" : "mt-5 border-t border-slate-100 pt-5"}>
            ...
            <article className="mt-8 flex items-start gap-4 rounded-3xl border border-amber-100 bg-amber-50 p-5">
              <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-amber-100 text-amber-700">
                <Icon name="info" className="h-5 w-5" />
              </span>
              <div>
                <h3 className="font-display text-sm font-bold text-amber-900">Your reputation supports your discount.</h3>
        ...
        <section id="rewards" className="bg-slate-50 py-20 md:py-28">
          <div className="section-shell">
            <SectionHeader
              badge="Rewards"
              icon="gift"
            ...
            <div className="mt-14 grid gap-8 lg:grid-cols-2">
              <article className="rounded-[2rem] border border-slate-100 bg-white p-7 shadow-sm">
                <h3 className="font-display text-lg font-extrabold text-slate-950">How points work</h3>
              ...
              <div className="flex flex-col gap-5">
                <article className="flex-1 rounded-[2rem] border border-slate-100 bg-white p-7 shadow-sm">
                  <div className="flex items-center gap-3">
                    <span className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-slate-100 text-slate-700">
                      <Icon name="eye" className="h-5 w-5" />
                    </span>
                    <h3 className="font-display text-base font-extrabold text-slate-950">Human reviewed and bias aware</h3>
                  </div>
        ...
        <section id="cta" className="cta-surface relative overflow-hidden py-20 md:py-28">
          ...
          <div className="section-shell relative">
            <div className="grid items-center gap-10 lg:grid-cols-5">
              ...
              <article className="rounded-[2rem] border-white/20 bg-white/10 p-7 text-white lg:col-span-2">
